...
### Промпт 1 — Структура проекта и зависимости
...
### Промпт 2 — Модели User и Course (SQLAlchemy 2.0)
...
### Промпт 3 — Модели Lesson, Enrollment, Quiz, Certificate
...
### Промпт 4 — BaseRepository и специфические репозитории
...
### Промпт 5 — Исправление фильтрации в BaseRepository.get_multi()
...
### Промпт 6 — Сервисы аутентификации и курсов
...
### Промпт 7 — Сервисы уроков, записей, тестов, сертификатов, аналитики
...
### Промпт 8 — FastAPI роутеры и main.py
...
### Промпт 10 — Docker и docker-compose
...
### Промпт 1 — Анализ ошибок и уязвимостей
...
### Промпт 2 — Изоляция тестов и UNIQUE constraint
...
### Промпт 3 — Отладка CI: StaticPool для SQLite in-memory
...
### Промпт 4 — Несовместимость passlib и bcrypt 4.1+
...
## CI/CD с интеграцией ИИ

### Промпт 1 — Workflow тестирования и покрытия
...
### Промпт 2 — Workflow AI code review через Anthropic API
...
## Генерация unit-тестов (≥90% покрытие)

### Промпт 1 — Настройка conftest.py и тестовых фикстур
...
### Промпт 3 — Тесты курсов и уроков
...
### Промпт 4 — E2E тесты записей, квизов, сертификатов, аналитики
...
## Повторный code review и исправление найденных проблем

### Промпт 1 — Поиск логических ошибок и проблем авторизации
...
### Промпт 2 — Исправление BaseRepository.update() и get_course_students()
